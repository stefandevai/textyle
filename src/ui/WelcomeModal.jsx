    ...
    ? (<Modal open={open} onClose={onClose}>
         <div className="flex flex-col">
           ...
           <div className='max-w-md text-base'>
             <p className='pb-4'>Textyle is a free and open source tilemap editor that is <span className='underline'>still in development</span>. The goal is to provide the most simple and straightforward way to create 2D tilemaps.</p>
