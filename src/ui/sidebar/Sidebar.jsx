...
const Sidebar = () => {
  ...
  const onSidebarStyles = showSidebar ? { width: '23vw', gridTemplateColumns: '40px 1fr' } : { width: '40px', gridTemplateColumns: '40px 0px' };
  const onSidebarStyles2 = showSidebar ? { width: '100%', borderRight: '1px solid rgb(75, 85, 99)' } : { width: '0' };
